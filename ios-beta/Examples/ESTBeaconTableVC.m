...
- (void)beaconManager:(ESTBeaconManager *)manager didRangeBeacons:(NSArray *)beacons inRegion:(ESTBeaconRegion *)region
{
    ...
    NSArray *sortedArray;
    sortedArray = [self.beaconsArray sortedArrayUsingComparator:^NSComparisonResult(id a, id b) {
        NSString *first = [(ESTBeacon*)a macAddress];
        NSString *second = [(ESTBeacon*)b macAddress];
